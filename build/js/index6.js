  ...
  var checkInputs = function(){
		...
		var bookNam = document.getElementById('bookNam');
  		...
  		if(bookName.value!==''){
			...
			var pList = bookName.nextSibling;
			if(pList){pList.remove()}
		...
		if(bookNam.value!==''){data.bookNam=bookNam.value;}else{data.bookNam=-1;}
	...
	var createBook = function(data){
		...
		if((data.bookName!=='')&&(data.bookAutor!=='')&&(data.bookYear!=='')&&(data.bookPicture!=='')){	
